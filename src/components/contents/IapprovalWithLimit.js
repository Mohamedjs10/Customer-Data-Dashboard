...
export default function ContentTable() {
  ...
  const url =
    dateFrom && dateTo
      ? `https://api-mobile.contact.eg/report/instant-approval?withLimit=true&from=${dateFrom}&to=${dateTo}&`
      : dateFrom
      ? `https://api-mobile.contact.eg/report/instant-approval?withLimit=true&from=${dateFrom}&`
      : dateTo
      ? `https://api-mobile.contact.eg/report/instant-approval?withLimit=true&to=${dateTo}&`
      : `https://api-mobile.contact.eg/report/instant-approval?withLimit=true&`;
